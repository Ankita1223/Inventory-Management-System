						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body">
						        ...
						        <p class="card-text">Here you view information about different employees</p>
						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body">
						        ...
						        <a href="#" class="btn btn-primary">View Inventories</a>
						      </div>
						    </div>
						</div>
					</div>	
						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body">
						        ...
						        <a href="#" class="btn btn-primary">Add Inventories</a>
						      </div>
						    </div>
						</div>
					</div>
